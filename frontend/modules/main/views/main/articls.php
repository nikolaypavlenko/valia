		...
		<div class="container">
			...
			<ul id="portfolio-items" class="row clearfix">
				...
				<!-- portfolio item example 1 -->
                                ...
                                <?php  foreach ($articls as $item) :?> 
                                    <li class="col-xlarge-3 col-medium-3 ">
                                            <a href="<?php echo Yii::$app->urlManager->createUrl(['main/main/detail', 'id' => $item->id]) ; ?> "  class="portfolio-item">
                                                    <img src="<?php echo $item->photo ?>" class="image" alt="" />
                                                    <!-- portfolio item hover -->
                                                    <div class="portfolio-hover">
                                                            <div class="portfolio-hover-content font-reg">
                                                                <h5 style="text-transform: uppercase; letter-spacing: 2px"><?php echo $item->name ?> </h5>
                                                                    <p>подробнее</p>
                                                            </div>
                                                    </div>
                                            </a>
