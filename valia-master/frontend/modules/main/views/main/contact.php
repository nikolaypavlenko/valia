                        ...
                        <?php $form = ActiveForm::begin([
                            ...
                            <div class="row">
                                <div class="col-xlarge-6 col-medium-6">
                                    <?= yii\helpers\Html::activeTextInput($model, 'name', ['class' => 'contact-input font-reg', 'placeholder' => 'имя']) ?>
                                    <span style="color:#F00"><?php echo $model->errors['name'][0]  ?></span>
                                </div>
                                <div class="col-xlarge-6 col-medium-6">  
                                    <?= yii\helpers\Html::activeTextInput($model, 'email', ['class' => 'contact-input font-reg', 'placeholder' => 'почта']) ?>
                                    <span style="color:#F00"> <?php echo $model->errors['email'][0]  ?> </span>
                                </div> 
                                
                            </div>
                            <div class="row">	
                                <div class="col-xlarge-12">
                                    <?= yii\helpers\Html::activeTextarea($model, 'body', ['class' => 'contact-text font-reg', 'placeholder' => 'сообщение']) ?>
                                    <span style="color:#F00"><?php echo $model->errors['body'][0]  ?></span>
                                </div>
                            </div>
